...
class Typeracer(Page):
    ...
    def before_next_page(self):
        ...
        my_list = ['state','reception', 'visit', 'restrict', 'sting', 'cow', 'bother', 'exaggerate', 'version', 'lift', 'virtue', 'pair', 'dedicate', 'matter', 'give', 'accent', 'deputy', 'situation', 'yard', 'glare', 'council', 'surface', 'eye', 'tax', 'novel', 'youth','vertical', 'remark', 'excess', 'economics', 'reserve', 'continental', 'employ']
