...
class Typeracer(Page):
    ...
    def before_next_page(self):
        ...
        my_list = ['mile', 'medal', 'conversation', 'broccoli', 'loss', 'layout', 'swipe', 'cruelty', 'traffic', 'koran', 'chicken', 'layout', 'swipe', 'war', 'young', 'layer', 'sale', 'series', 'vertical', 'translate', 'string', 'club', 'flavor', 'giant', 'shape', 'laser', 'infect', 'south', 'conservation', 'alcohol']
