...
class Answer_flag(Page):
    ...
    def before_next_page(self):
        ...
        if self.player.flag1 == "Brazil":
            #Hvor mye poeng man får for å ha rett
            self.player.this_round_point = self.player.this_round_point + 5
            
        if self.player.flag2 == "USA":
            self.player.this_round_point = self.player.this_round_point + 5
            
        if self.player.flag3 == "UK":
            self.player.this_round_point = self.player.this_round_point + 5
            
        if self.player.flag4 == "Canada":
            self.player.this_round_point = self.player.this_round_point + 5
            
        if self.player.flag5 == "Sweden":
            self.player.this_round_point = self.player.this_round_point + 5
            
        if self.player.flag6 == "Australia":
            self.player.this_round_point = self.player.this_round_point + 5
            
        if self.player.flag7 == "China":
            self.player.this_round_point = self.player.this_round_point + 5
