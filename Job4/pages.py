...
class Equations(Page):
    ...
    def before_next_page(self):
        ...
        if self.player.eq1 == 4:
            #Hvor mye poeng man får for å ha rett
            self.player.this_round_point = self.player.this_round_point + 3
            
        if self.player.eq2 == 40:
            self.player.this_round_point = self.player.this_round_point + 3
            
        if self.player.eq3 == 15:
            self.player.this_round_point = self.player.this_round_point + 3
            
        if self.player.eq4 == 74:
            self.player.this_round_point = self.player.this_round_point + 3
            
        if self.player.eq5 == 36:
            self.player.this_round_point = self.player.this_round_point + 3
            
        if self.player.eq6 == 21:
            self.player.this_round_point = self.player.this_round_point + 3
            
        if self.player.eq7 == 22:
            self.player.this_round_point = self.player.this_round_point + 3
            
        if self.player.eq8 == 11:
            self.player.this_round_point = self.player.this_round_point + 3
            
        if self.player.eq9 == 60:
            self.player.this_round_point = self.player.this_round_point + 3
            
        if self.player.eq10 == 17:
            self.player.this_round_point = self.player.this_round_point + 3
