...
class Typeracer(Page):
    ...
    def before_next_page(self):
        ...
        my_list = ['fund', 'prayer', 'stir', 'last', 'increase', 'lay', 'forecast', 'spirit', 'justice', 'island', 'friend', 'urine', 'analyst', 'mutter', 'battle', 'field', 'favour', 'irony', 'castle', 'wrestle', 'bedroom', 'constituency', 'hierarchy', 'recruit', 'place', 'studio', 'banquet', 'herd', 'tourist', 'polite', 'brown']
